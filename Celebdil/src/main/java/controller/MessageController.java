...
public class MessageController {
    ...
    public @ResponseBody boolean sendMessage(@RequestParam Map<String,String> allParams) {
    ...
    public @ResponseBody List<Message> getMessagesToUser(@RequestParam Map<String,String> allParams) {
    ...
    public @ResponseBody List<Message> getMessagesFromUser(@RequestParam Map<String,String> allParams) {
        String accountNumber = allParams.get(ACCOUNT_NUMBER_KEY);
    ...
    public @ResponseBody List<Message> getMessagesBetweenUsers(@RequestParam Map<String,String> allParams) {
